...
# Load full historical data for use in historic catch comparison
# AdultWeirData <- load_weir_data("../data/AdultWeirData.rda")
# AdultWeirData_clean <- clean_weir_data(AdultWeirData)
# 
# GRSME_df <- get_grsme_df(trap_year = trap.year, grsme_data = "fins")

data_list <- get_trap_data(download_cdms = FALSE, trap_year = 2024)
